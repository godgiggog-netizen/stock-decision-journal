...
const TH={
  stage:{EARLY:'ระยะเริ่มต้น',CONFIRMED:'ยืนยันแล้ว',CROWDED:'ตลาดรับรู้มากแล้ว'},
  entry:{'WAIT FOR CONFIRMATION':'รอการยืนยัน','WAIT FOR PULLBACK':'รอราคาย่อ','BUY ZONE':'โซนซื้อ','EXTENDED':'ราคาวิ่งไกลแล้ว','CROWDED':'ตลาดหนาแน่น','AVOID':'หลีกเลี่ยง'},
  thesis:{STRONGER:'Thesis แข็งขึ้น',UNCHANGED:'Thesis คงเดิม',WEAKER:'Thesis อ่อนลง'},
  verdict:{'HIGH PRIORITY':'สำคัญสูง',WATCH:'เฝ้าดู','EARLY RADAR':'Radar ระยะแรก','MATERIAL CHANGE':'มีการเปลี่ยนแปลงสำคัญ'}
};
